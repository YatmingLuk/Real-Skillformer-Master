...
class config:
  exp_name: str
  DATA_PATH = '/home/thsxw/Wayformer-Nuplan-dataset/nuplan-v1.1/mini' # /home/test/pluto_epi/nuPlan_mini/nuplan-v1.1/splits
  MAP_PATH  = '/home/thsxw/Wayformer-Nuplan-dataset/maps' # /home/test/real-Skillformer-master/processed_data
  SAVE_PATH = '/home/test/real-Skillformer-master/processed_data/'
  MAP_VERSION = "nuplan-maps-v1.0"
  temp_file_dir : str = '/home/test/real-Skillformer-master/config'
  ...
  # VAE integration
  vae_weight_path: str = 'pth/trajectory_vae_8d_best.pth'
  vae_latent_dim: int = 8

  # skill head supervision
  use_z_norm: bool = False
  z_stats_path: str = 'z_stats.pt'
